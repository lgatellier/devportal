...
def vm_list(vms: list):
    ...
    table = ui.table(
        columns=COLUMNS, rows=vms, row_key="uuid"
    ).classes("w-full")
    ...
    table.add_slot('body', r'''
        <q-tr :props="props">
            ...
            <q-td>
                <q-btn color="positive" icon="play_circle" round @click="() => $parent.$emit('start', props.row)" />
                <q-btn color="negative" icon="stop_circle" round @click="() => $parent.$emit('stop', props.row)" />
                <q-btn color="warning" icon="restart_alt" round @click="() => $parent.$emit('restart', props.row)" />
            </q-td>
        </q-tr>
    ''')
